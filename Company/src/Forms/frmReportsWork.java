 ...
 * @author drmas
 */
public class frmReportsWork extends javax.swing.JFrame {

    /**
     * Creates new form frmReports
     */
    public frmReportsWork() {
        initComponents();
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        db.go.fillToJTable("workno_data", tblWorkReport);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmReportsWork.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmReportsWork().setVisible(true);
            }
        });
    }
